...
globals [powerupcountdown wave gameover? upgrading? powertype deflection]
...
to setup
  ...
  create-players 1 [set powerduration 0 set powerupspawnrate 1 set numbeams 1 set speed 3 set damage 1 set accuracy 2 set shootspeed 10 set shieldsize 30 set size 17 set shape "charactertank" set reload 0 set health 100]
...
to healthupdate
  set hidden? false
  setxy [xcor] of turtle 0 [ycor] of turtle 0 - 8
...
to playerupdate
  ...
  ifelse powertype = 4 [set deflection true] [ifelse powertype = 3 [set normalreload reload set reload 100 set powerduration 500][ifelse powertype = 2 [set normalshieldsize shieldsize set shieldsize 180 set powerduration 700][ifelse powertype = 1 [ask enemies [die]][set reload normalreload set shieldsize normalshieldsize]]]]
