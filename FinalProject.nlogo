...
globals [donesettingup? invincible start? playerbeamspeed powerupcountdown wave gameover? upgrading? powertype deflection]

beams-own [beamspeed side]
players-own [powerupspawnrate powerduration normalreload reload health numbeams damage accuracy shieldsize money speed shootspeed]
enemies-own [enemytype HP reload]
powerups-own [power durationleft]

to setup
  if donesettingup? = 0 [ca
    set gameover? false
    set start? false
    set wave 1
    set gameover? false
    ...
    create-players 1 [set color blue set playerbeamspeed 1 set normalreload 10 set powerduration 0 set powerupspawnrate 1 set numbeams 1 set speed 1 set damage 1 set accuracy 2 set shootspeed 10 set shieldsize 30 set size 17 set shape "charactertank" set reload 0 set health 100]
    ...
    reset-ticks
    set donesettingup? 1]
  ifelse not gameover? [ifelse start? [go][if mouse-down? and mouse-inside? and ticks mod 3 = 1 [if mouse-xcor > -60 and mouse-xcor < 60 and mouse-ycor > -70 and mouse-ycor < -40 [set start? true clear-drawing ask turtle 0[set hidden? false ask turtle 1 [set hidden? false]]]]] tick]
  [showgameoverscreen]
end
...
to showgameoverscreen
  ...
  ask patch 25 -90 [set plabel "Click to play again"]
  if mouse-down? and mouse-inside? [set donesettingup? 0 set gameover? false set start? false]
  tick
end
...
to showupgradescreen
  ...
  if mouse-inside? [
    ifelse mouse-xcor > -73 and mouse-xcor < -43 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtles-on patch 98 18 [set label (word "Speed (" [speed] of turtle 0 ") - increase how fast you move")]][
      ifelse mouse-xcor > -73 and mouse-xcor < -43 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtles-on patch 98 18 [set label (word "Accuracy (" ([accuracy] of turtle 0 - 1) ") - increase how accurate your beams are")]][
        ifelse mouse-xcor > -33 and mouse-xcor < -3 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtles-on patch 98 18 [set label (word "Beams (" [numbeams] of turtle 0 ") - increase how many beams you shoot")]][
          ifelse mouse-xcor > 6 and mouse-xcor < 36 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtles-on patch 98 18 [set label (word "Damage (" [damage] of turtle 0 ") - increase how much damage you do")]][
            ifelse mouse-xcor > 45 and mouse-xcor < 75 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtles-on patch 98 18 [set label (word "Health (" [health] of turtle 0 ") - increase how much health you have")]][
              ifelse mouse-xcor > -33 and mouse-xcor < -3 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtles-on patch 98 18 [set label (word "Reload speed (" ([shootspeed] of turtle 0 - 9) ") - increase how fast you shoot")]][
                ifelse mouse-xcor > 6 and mouse-xcor < 36 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtles-on patch 98 18 [set label (word "Shield size (" ([shieldsize] of turtle 0 - 29) ") - increase how big your shield is")]][
                  ifelse mouse-xcor > 45 and mouse-xcor < 75 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtles-on patch 98 18 [set label (word "Powerup rate (" [powerupspawnrate] of turtle 0 ") - increase how fast powerups spawn")]][ask turtles-on patch 98 18 [set label ""]]
                ]
              ]
            ]
          ]
    ...
    if mouse-down?[
      ifelse mouse-xcor > -73 and mouse-xcor < -43 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtle 0 [if money > 4 [set speed speed + 1 set money money - 5]]][
            ...
            ifelse mouse-xcor > 6 and mouse-xcor < 36 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtle 0 [if money > 4 [set money money - 5 set damage damage + 1]]][
              ifelse mouse-xcor > 45 and mouse-xcor < 75 and mouse-ycor > -30 and mouse-ycor < 0 [ask turtle 0 [if money > 4 [set money money - 5 set health health + 25]]][
                ifelse mouse-xcor > -33 and mouse-xcor < -3 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtle 0 [if money > 4 [set normalreload normalreload + 1 set money money - 5 set shootspeed shootspeed + 1]]][
                  ifelse mouse-xcor > 6 and mouse-xcor < 36 and mouse-ycor > -70 and mouse-ycor < -40 [ask turtle 0 [if money > 4 [set shieldsize shieldsize + 3 set money money - 5]]][
...
to w
  if not Hardmode and start? and not upgrading? [ask players [fd (8 + speed) / 3]]
end

to a
  if not Hardmode and start? and not upgrading? [ask players [set heading heading - 90 fd (8 + speed) / 3 set heading heading + 90]]
end

to s
  if not Hardmode and start? and not upgrading? [ask players [bk (8 + speed) / 3]]
end
